...
tuesday.addEventListener("click", function() {
	modal.style.display = "block";
	classImg.src = "http://modernyogacleveland.com/wp-content/uploads/2016/08/IMG_20160720_183449-e1472422766623.jpg";
...
wednesday.addEventListener("click", function() {
	modal.style.display = "block";
	classImg.src = "https://bikramdurham.com/wp-content/uploads/2016/06/yoga-meditation-class-1000x667..jpg";
...
thursday.addEventListener("click", function() {
	modal.style.display = "block";
	classImg.src = "https://d342jfhztpgus0.cloudfront.net/images/334/334557/7659_647-640x320.jpg";
...
friday.addEventListener("click", function() {
	modal.style.display = "block";
	classImg.src = "http://www.gathertogetheryoga.com/wp-content/uploads/2015/08/Depositphotos_60167695_l-2015.jpg";
...
saturday.addEventListener("click", function() {
	modal.style.display = "block";
	classImg.src = "http://www.shineyogauk.com/wp-content/uploads/2016/08/Beginners-Yoga-Newquay.jpg";
...
sunday.addEventListener("click", function() {
	modal.style.display = "block";
	classImg.src = "http://matchbin-assets.s3.amazonaws.com/public/sites/351/assets/J0DM_WEB_1a_DSC_0112.jpg";
